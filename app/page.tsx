  ...
  return (
    <main>
      <div style={{ backgroundColor: "var(--color6)", zIndex: 0, position: "relative", display: "flex", flexWrap: "wrap", overflow: "clip", color: "var(--textColor2)", alignItems: "flex-start" }}>
        ...
        {globalFormData.specificData.pages.home.section1.fieldType === "section" && globalFormData.specificData.pages.home.section1.inputs.image1.fieldType === "image" && (
          <div style={{ flex: "1 1 600px", zIndex: 1, minHeight: "400px", position: "relative" }}>
            <Image alt={globalFormData.specificData.pages.home.section1.inputs.image1.alt} src={globalFormData.specificData.pages.home.section1.inputs.image1.value} priority={true} fill={true} style={{ objectFit: "cover", objectPosition: "bottom" }} />
          </div>
        )}
      ...
      {globalFormData.specificData.pages.home.section2.fieldType === "contactComponent" && globalFormData.specificData.pages.home.section2.using && (
        <section style={{ backgroundColor: "var(--color5)" }}>
          <ContactUs contacts={globalFormData.specificData.pages.home.section2.component} />
        </section>
      )}
    </main>
  );
