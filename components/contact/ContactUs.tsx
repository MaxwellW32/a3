...
export default function ContactUs({ contacts }: { contacts: contactComponentType["component"] }) {
    ...
    return (
        <div style={{ display: "flex", flexWrap: "wrap", gap: "vaR(--gapSmall)", justifyContent: "center", alignItems: "center", width: "min(1000px, 100%)", margin: "0 auto" }}>
            ...
            {globalFormData.specificData.pages.home.section1.fieldType === "section" && globalFormData.specificData.pages.home.section1.inputs.image2.fieldType === "image" && (
                <div style={{ flex: "0 0 auto", position: "relative", width: "min(250px, 80vw)", aspectRatio: "1/1" }}>
                    <Image alt={globalFormData.specificData.pages.home.section1.inputs.image2.alt} src={globalFormData.specificData.pages.home.section1.inputs.image2.value} fill={true} sizes="(max-width: 200px) 100vw, (max-width: 600px) 50vw, 33vw" style={{ objectFit: "cover", borderRadius: "var(--radiusAmountLarge)", }} />
                </div>
            )}
